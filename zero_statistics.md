...
。これに対し、索引は10万件の状態で統計を収集(索引作成時に自動で統計情報が収集される)しているためリーフブロック数が33334となっているため索引スキャンのCOSTはFULLスキャンよりも大きくなります。
...
## 0件統計
<!--stackedit_data:
eyJoaXN0b3J5IjpbODU0OTgxNTQ5LDY0MjQzMjI1LC03NTc0OT
