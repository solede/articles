...
ORACLEは統計情報を元に実行計画を立てますが、典型的におかしな実行計画となるケースとして０件の状態で収集した統計情報になっている、ということが挙げられます。。本ページでは実際にコードで試して何故ダメなのかを解説します。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTExMTA2NjM4Myw4MjgzNDgwMDRdfQ==
-->